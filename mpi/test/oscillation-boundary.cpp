...
int main(int argc, char** argv) {
    ...
    if (OPTIONS.dimx != 2 || OPTIONS.dimy != 1 || OPTIONS.dimz != 1) {
    ...
    particles = (MPI_OPTIONS.coords[0] == 0)
        ? vector<Particle>{Particle{custom_cell_size - 0.6, custom_cell_size / 2, custom_cell_size / 2}}
        : vector<Particle>{Particle{0.6, custom_cell_size / 2, custom_cell_size / 2}};
